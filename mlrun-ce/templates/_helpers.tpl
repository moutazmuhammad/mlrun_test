...
{{- define "mlrun.storage.auto.mount.params" -}}
  ...
  {{- else if not .Values.global.infrastructure.aws.s3NonAnonymous -}}
    "endpoint_url={{ include "mlrun-ce.minio.service.url" . }}"
  {{- else -}}
    "non_anonymous=True"
  {{- end -}}
{{- end -}}
...
*/}}
{{- define "mlrun-ce.minio.credentials.secretName" -}}
{{- if .Values.minio.existingSecret -}}
{{- .Values.minio.existingSecret -}}
{{- else -}}
{{- .Values.minio.credentialsSecretName | default "minio-credentials" -}}
{{- end -}}
{{- end -}}
